        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center">
                    <h3 class="card-title flex-grow-1">Tipos de Comprobante</h3>
...
@canany(['comprobante_tipos_create', 'comprobante_tipos_edit'])
    @include('comprobante-tipos.action')
@endcanany
@endsection
@push('scripts')
<script>
class ComprobanteManager extends CrudManager {
    constructor() {
        super("{{ url('comprobante-tipos') }}");
    ...
    async showEditModal(id) {
        try {
            ...
            this.elements.modalTitle.textContent = 'Editar Tipo Comprobante: '+ response.descripcion;
            ...
            document.getElementById('modulo').value = response.modulo || '';
    ...
    showCreateModal(){
        ...
        this.elements.modalTitle.textContent = 'Nuevo Tipo Comprobante';
    }
}
document.addEventListener('DOMContentLoaded', () => {
    new ComprobanteManager();
});
document.getElementById('mnuConfiguracion').classList.add('menu-open');
document.getElementById('itemComprobanteTipo').classList.add('active');
</script>
@endpush