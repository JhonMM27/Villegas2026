        ...
        <div class="modal-content">
            <form id="formUpdate" method="post">
                ...
                <div class="modal-header">
                    <h4 class="modal-title fs-5" id="modalTitle">Nuevo Tipo de Costo</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="border border-primary rounded p-3 mb-3">
                        <h6 class="text-primary mb-3">
                            <i class="bi bi-tag me-2"></i>Datos del Tipo
                        </h6>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="categoria_costo_id" class="form-label">Categoría</label>
                            <select id="categoria_costo_id" name="categoria_costo_id" class="form-select form-select-sm">
                    ...
                    <div class="border border-secondary rounded p-3">
                        <h6 class="text-secondary mb-3">
                            <i class="bi bi-circle-fill me-2" style="font-size:0.5rem;"></i>Estado
                        </h6>
