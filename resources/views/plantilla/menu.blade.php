<aside class="app-sidebar sidebar-light" data-bs-theme="light">
    ...
    <div class="sidebar-wrapper">
        <nav class="mt-2">
            ...
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                ...
                @canany(['cobranza_tipos_list', 'comprobante_tipos_list', 'sunat_list', 'pago_formas_list',
                    'pago_medios_list', 'operacion_tipos_list', 'comprobante_tipos_list', 'documento_tipos_list',
                ...
                @canany(['caja_pagos_list', 'caja_pagos_report', 'venta_provisionales_list',
                    'compra_provisionales_list', 'gastos_list', 'costos_list'])
    ...
    @endcan
                            ...
                            @can('costos_report')
                                <li class="nav-item">
                                    <a href="{{ route('reportes.costos.resumen') }}" class="nav-link"
                                        id="itemReporteCostos">
                                        <p>Reporte Costos</p>
                                    </a>
                                </li>
                            @endcan
                ...
                @canany(['empleados_list', 'planilla_adelantos_list', 'planilla_prestamos_list', 'planilla_pagos_list',
                    'planilla_inasistencias_list', 'planilla_report'])
