<div class="border border-danger rounded px-2 py-1 mt-2 mt-md-0">
    ...
    <div class="row g-1 align-items-center mt-1">
        <div class="col-1 text-end fw-bold" style="font-size:0.7rem;">1</div>
        <div class="col-7">
    ...
    <div class="row g-1 align-items-center">
        <div class="col-1 text-end fw-bold" style="font-size:0.7rem;">2</div>
        <div class="col-7">
    ...
    <div class="row g-1 align-items-center">
        <div class="col-1 text-end fw-bold" style="font-size:0.7rem;">3</div>
        <div class="col-7">
    ...
    <div class="row g-1 mt-1">
        <div class="col-8"></div>
        <div class="col-4">
            <input type="text" name="total_caja" id="total_caja" class="form-control form-control-sm py-0 text-end fw-bold" value="0.00" readonly>
        </div>
    </div>
</div>
