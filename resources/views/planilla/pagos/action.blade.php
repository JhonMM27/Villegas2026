                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="border border-primary rounded p-3">
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        <div class="mb-2">
                                            ...
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="text" id="sueldo_planilla" class="form-control" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="mb-2">
                                            <label for="horas_extras" class="form-label text-muted small">H. Extras</label>
                                            <div class="input-group input-group-sm">
                                                <span class="input-group-text">S/</span>
                                ...
                                <div class="row mt-2">
                                    <div class="col-lg-3">
                                        <div class="mb-2">
                                            <label for="dias_faltados" class="form-label text-muted small">Días Faltados</label>
                                            <div class="input-group input-group-sm">
                                                <input type="number" id="dias_faltados" name="dias_faltados"
                                                    class="form-control" step="0.01" min="0" max="30" value="0">
                                ...
                                <div id="cts_section" class="row mt-2 d-none">
                                    <div class="col-lg-3">
                                        <div class="mb-2">
                                            <label for="cts_planilla" class="form-label text-muted small">CTS (Planilla)</label>
                                            <div class="input-group input-group-sm">
                                                <span class="input-group-text">S/</span>
                                                <input type="number" id="cts_planilla" name="cts_planilla"
                                    ...
                                    <div class="col-lg-3">
                                        <div class="mb-2">
                                            <label for="cts_sueldo_real" class="form-label text-muted small">CTS (Sueldo Real)</label>
                                            <div class="input-group input-group-sm">
                                                <span class="input-group-text">S/</span>
                                                <input type="number" id="cts_sueldo_real" name="cts_sueldo_real"
                                                    class="form-control" step="0.01" min="0" value="">
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="border border-success rounded p-3 mb-3">
                                <h6 class="text-success mb-3"><i class="bi bi-currency-dollar me-2"></i>Total a Pagar</h6>
                                <div class="text-center">
                                    ...
                                    <p class="text-muted small mb-0 mt-1">Disp. + H. Extras - Desc. Faltas + CTS</p>
                                </div>
                            </div>
