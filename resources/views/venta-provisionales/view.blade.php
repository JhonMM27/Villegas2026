        ...
        <div class="modal-content fs-7">
            <div class="modal-header">
                <h4 class="modal-title fs-5" id="modalTitle">
                    Detalle de Provisional - Recibo {{ $provisional->numero_recibo }}
                </h4>
                        ...
                        <div class="border border-primary rounded p-3">
                            <div class="row mb-2">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <p class="fw-bold">{{ number_format((float)$provisional->libre, 2) }}</p>
                                </div>
                        ...
                        <div class="border border-primary rounded px-2 py-1 mt-2 mt-md-0">
                            <div class="row mb-2">
                                <div class="col-md-12">
                                    ...
                                    <p class="fw-bold">{{ $provisional->cliente_nombre }}</p>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">ID Cliente:</label>
                                    <p class="fw-bold">{{ $provisional->cliente_id }}</p>
                                </div>                                
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        @forelse($provisional->detalles as $index => $d)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $d->venta_id }}</td>
