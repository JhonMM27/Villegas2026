    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content fs-7">
            <form id="formUpdate" method="post">
                ...
                <input type="hidden" id="prestamo_anulado_id" name="prestamo_anulado_id" value="">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-7">
                          @include('prestamos.partials.comprobante-form')
                        </div>
                        <div class="col-lg-5">
                          @include('prestamos.partials.cliente-form')
                        </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-lg-12">
                          @include('prestamos.partials.tabla-detalles')
                        </div>
                    </div>
                </div>
