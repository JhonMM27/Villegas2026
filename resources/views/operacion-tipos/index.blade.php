        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center">
                    <h3 class="card-title flex-grow-1">Tipo de Operación</h3>
                    @can('operacion_tipos_create')
...
@canany(['operacion_tipos_create', 'operacion_tipos_edit'])
    @include('operacion-tipos.action')
@endcanany
@endsection
@push('scripts')
<script>
class OperacionTipoManager extends CrudManager {
    constructor() {
        super("{{ url('operacion-tipos') }}");
    ...
    async showEditModal(id) {
        try {
            ...
            this.elements.modalTitle.textContent = 'Editar Tipo Operación: '+ response.descripcion;
    ...
    showCreateModal(){
        ...
        this.elements.modalTitle.textContent = 'Nuevo Tipo Operación';
    }
}
document.addEventListener('DOMContentLoaded', () => {
    new OperacionTipoManager();
});
document.getElementById('mnuConfiguracion').classList.add('menu-open');
document.getElementById('itemOperacionTipo')?.classList.add('active');
</script>
@endpush
