...
<html>
@include('pdf.styles', [
    'title' => "Reporte: Ventas Agrupadas producto ({$ini->format('d/m/Y')} al {$fin->format('d/m/Y')})"
...
<body>
    ...
    <div class="page-header">
        <table>
            ...
            <tr>
                <td>
                    Reporte: Ventas agrupadas producto ({{ $ini->format('d/m/Y') }} al {{ $fin->format('d/m/Y') }})
                </td>
                <td class="text-right">
    ...
    <table class="reporte">
        ...
        <tbody>
            ...
            @forelse($reportes as $r)
                ...
                <tr class="linea2">
                    {{-- Si ya tienes fecha_venta_fmt en el backend, usa esa y evitas Carbon --}}
