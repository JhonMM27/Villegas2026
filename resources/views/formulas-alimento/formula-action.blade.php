            ...
            <form id="formFormula" method="post">
                ...
                <div class="modal-header bg-light py-2">
                    <h5 class="modal-title fs-6" id="formulaTitle">
                        <i class="bi bi-calculator me-2"></i>Nueva Fórmula
                    </h5>
                                ...
                                <div class="row g-2">
                                    <div class="col-12">
                                        ...
                                        <input type="text" id="formula_nombre" name="nombre"
                                               class="form-control form-control-sm form-control-sm" required maxlength="100">
                                ...
                                <div class="col-md-6">
                                    <div class="border border-info rounded p-2">
                                        ...
                                        <table class="table table-sm mb-0" style="font-size: 0.78rem;">
                                            ...
                                            <tr><td>ENL (Mcal/kg)</td><td class="text-end fw-bold" id="nut_enl">—</td></tr>
