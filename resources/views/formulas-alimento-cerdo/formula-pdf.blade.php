...
<head>
    <meta charset="UTF-8">
    <title>Fórmula Cerdo — {{ $data['formula']['nombre'] }}</title>
    <style>
        ...
        .nutricion-box { border: 1px solid #0dcaf0; border-radius: 4px; padding: 6px; }
        .costos-box { border: 1px solid #198754; border-radius: 4px; padding: 6px; }
        .footer { font-size: 8px; color: #6c757d; text-align: center; margin-top: 10px; }
    </style>
</head>
<body>
    <h1 style="font-size: 16px; text-align: center; margin-bottom: 8px;">
        FÓRMULA DE ALIMENTO — CERDOS
    </h1>
    ...
    <div class="header-box">
        <table style="border-collapse: separate; border-spacing: 8px 0;">
            <tr>
                <td style="width: 35%; border-right: 1px solid #fd7e14; padding: 2px 8px 2px 0;">
                ...
                <td style="width: 15%; border-right: 1px solid #fd7e14; padding: 2px 8px;">
                ...
                <td style="width: 20%; border-right: 1px solid #fd7e14; padding: 2px 8px;">
        ...
        <table class="table-bordered">
            <thead>
                <tr>
                    ...
                    <th style="width: 11%;">Procedencia</th>
                    <th style="width: 11%;">Nutriente</th>
                    ...
                    <table style="font-size: 8.5px;">
                        <tr>
                            <td style="width: 50%; padding-right: 6px;">
                                <table>
                                    <tr><td>Materia Seca</td><td class="text-end">{{ number_format($n['materia_seca'], 4) }}</td></tr>
                                    <tr><td>Proteína Cruda</td><td class="text-end">{{ number_format($n['proteina_cruda'], 4) }}</td></tr>
                                    <tr><td>EM (Mcal/kg)</td><td class="text-end">{{ number_format($n['em'], 4) }}</td></tr>
                                    <tr><td>Grasa</td><td class="text-end">{{ number_format($n['grasa'], 4) }}</td></tr>
                                    <tr><td>Fibra</td><td class="text-end">{{ number_format($n['fibra'], 4) }}</td></tr>
                                    <tr><td>FDN</td><td class="text-end">{{ number_format($n['fdn'], 4) }}</td></tr>
                                    <tr><td>FDA</td><td class="text-end">{{ number_format($n['fda'], 4) }}</td></tr>
                                    <tr><td>Calcio</td><td class="text-end">{{ number_format($n['calcio'], 4) }}</td></tr>
                                    <tr><td>Fósforo</td><td class="text-end">{{ number_format($n['fosforo'], 4) }}</td></tr>
                                </table>
                            </td>
                            <td style="width: 50%; padding-left: 6px;">
                                <table>
                                    <tr><td>Magnesio</td><td class="text-end">{{ number_format($n['magnesio'], 4) }}</td></tr>
                                    <tr><td>Almidón</td><td class="text-end">{{ number_format($n['almidon'], 4) }}</td></tr>
                                    <tr><td>Azúcar</td><td class="text-end">{{ number_format($n['azucar'], 4) }}</td></tr>
                                    <tr><td>Ceniza</td><td class="text-end">{{ number_format($n['ceniza'], 4) }}</td></tr>
                                    <tr><td>Lactosa</td><td class="text-end">{{ number_format($n['lactosa'], 4) }}</td></tr>
                                    <tr><td>Lisina</td><td class="text-end">{{ number_format($n['lisina'], 4) }}</td></tr>
                                    <tr><td>Metionina</td><td class="text-end">{{ number_format($n['metionina'], 4) }}</td></tr>
                                    <tr><td>Treonina</td><td class="text-end">{{ number_format($n['treonina'], 4) }}</td></tr>
                                </table>
                            </td>
                        </tr>
                    </table>
