{{--
    Modal de exportación para Fórmulas de Cerdos.
    Reutiliza la misma estructura que el modal de Vacuno.
--}}
        ...
        <div class="modal-content">
            <div class="modal-header bg-light py-2">
                <h5 class="modal-title fs-6">
                    <i class="bi bi-piggy-bank me-2"></i>Exportar Fórmula (Cerdos)
                </h5>
