{{-- ============================================================
    ...
    Compacto (max-width 1100px) - Cerdos (17 nutrientes en 2 columnas)
============================================================ --}}
        ...
        <div class="modal-content" style="font-size: 0.78rem;">
            <div class="modal-header bg-light py-2">
                <h5 class="modal-title fs-6">
                    <i class="bi bi-piggy-bank me-2"></i>Detalle de Fórmula (Cerdos)
                </h5>
                            ...
                            <div class="row g-1" style="font-size: 0.78rem;">
                                <div class="col-6">
                                    <table class="table table-sm mb-0">
                                        ...
                                        <tr><td>EM (Mcal/kg)</td><td class="text-end fw-bold" id="view_em">—</td></tr>
                                        <tr><td>Grasa</td><td class="text-end fw-bold" id="view_grasa">—</td></tr>
                                        <tr><td>Fibra</td><td class="text-end fw-bold" id="view_fibra">—</td></tr>
                                        <tr><td>FDN</td><td class="text-end fw-bold" id="view_fdn">—</td></tr>
                                        <tr><td>FDA</td><td class="text-end fw-bold" id="view_fda">—</td></tr>
                                        <tr><td>Calcio</td><td class="text-end fw-bold" id="view_calcio">—</td></tr>
                                        <tr><td>Fósforo</td><td class="text-end fw-bold" id="view_fosforo">—</td></tr>
                                    </table>
                                </div>
                                <div class="col-6">
                                    <table class="table table-sm mb-0">
                                        <tr><td>Magnesio</td><td class="text-end fw-bold" id="view_magnesio">—</td></tr>
                                        ...
                                        <tr><td>Ceniza</td><td class="text-end fw-bold" id="view_ceniza">—</td></tr>
                                        <tr><td>Lactosa</td><td class="text-end fw-bold" id="view_lactosa">—</td></tr>
                                        <tr><td>Lisina</td><td class="text-end fw-bold" id="view_lisina">—</td></tr>
                                        <tr><td>Metionina</td><td class="text-end fw-bold" id="view_metionina">—</td></tr>
                                        <tr><td>Treonina</td><td class="text-end fw-bold" id="view_treonina">—</td></tr>
                                    </table>
                                </div>
                            </div>
                        </div>
