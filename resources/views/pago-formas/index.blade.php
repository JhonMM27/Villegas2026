        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center">
                    <h3 class="card-title flex-grow-1">Formas de Pago</h3>
                    @can('pago_formas_create')
...
@canany(['pago_formas_create', 'pago_formas_edit'])
    @include('pago-formas.action')
@endcanany
@endsection
@push('scripts')
<script>
class PagoFormaManager extends CrudManager {
    constructor() {
        super("{{ url('pago-formas') }}");
    ...
    async showEditModal(id) {
        try {
            ...
            this.elements.modalTitle.textContent = 'Editar Forma de Pago: '+ response.descripcion;
            ...
            document.getElementById('dias').value = response.dias || '0';
    ...
    showCreateModal(){
        ...
        this.elements.modalTitle.textContent = 'Nueva Forma de Pago';
    }
}
document.addEventListener('DOMContentLoaded', () => {
    new PagoFormaManager();
});
document.getElementById('mnuConfiguracion').classList.add('menu-open');
document.getElementById('itemPagoForma').classList.add('active');
</script>
@endpush
