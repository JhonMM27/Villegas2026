    ...
    <script>
        ...
        `;
            ...
            addProductoToTable(item, cantidad = 1, precio_unitario = null, entregado = null, subtotal = null) {
                ...
                if (existingRow) {
                    ...
                    const precio = parseFloat(existingRow.querySelector('.inputPrecioUnitario').value) ||
                        precioConImpuesto;
                ...
                <td class="text-end">
                    <input type="number" step="any" name="detalles[${rowCount}][precio_unitario]" value="${precioConImpuesto.toFixed(4)}" class="form-control form-control-sm inputPrecioUnitario" style="background-color: #fff3cd;">
                </td>
                <td class="text-end">
            ...
            calculateTotals() {
                ...
                [...tbody.querySelectorAll('tr')].forEach(row => {
                    ...
                    let baseSinImpuesto = itemSubtotal,
                        impuesto = 0;
            ...
            initializeDataTable() {
                this.tabla = $(this.elements.table).DataTable({
                    ...
                    columns: [{
                        ...
                        {
                            data: 'pago_forma_nombre',
                            name: 'pago_forma_nombre'
                        },
                        {
                            data: 'cliente_nombre',
                            name: 'cliente_nombre'
                        ...
                        {
                            data: 'comprobante_tipo_nombre',
                            name: 'comprobante_tipo_nombre'
                        },
                        {
                            data: 'serie',
                            name: 'serie'
            ...
            async showEditModal(id) {
                try {
                    ...
                    this.elements.modalTitle.textContent = 'Editar Venta: ' + response.comprobante_tipo_codigo + ' ' +
            ...
            async showRectifyModal(id) {
                try {
                    ...
                    this.elements.modalTitle.textContent =
                        'Rectificar venta ' + response.comprobante_tipo_codigo + ' ' + response.serie + '-' + response
                        .correlativo;
            ...
            async duplicateShowModal(id) {
                try {
                    ...
                    this.elements.modalTitle.textContent =
                        'Duplicar venta ' + response.comprobante_tipo_codigo + ' ' + response.serie + '-' + response
                        .correlativo;
            ...
            async registerSupplier() {
                ...
                try {
                    ...
                    if (response.ok && data.success && data.cliente) {
                        ...
                        document.getElementById('cliente_razon_social').value = data.cliente.id + ' - ' + data.cliente
                            .razon_social;
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.body.addEventListener('click', function(e) {
                if (e.target && (e.target.matches('.btn-view-venta') || e.target.closest(
                        '.btn-view-venta'))) {
                ...
                if (e.target && (e.target.matches('.btn-rectificar-venta') || e.target.closest(
                        '.btn-rectificar-venta'))) {
                ...
                if (e.target && (e.target.matches('.btn-duplicate-venta') || e.target.closest(
                        '.btn-duplicate-venta'))) {
                ...
                // ─── Botón Anular Venta ──────────────────────────────────
                if (e.target && (e.target.matches('.btn-anular-venta') || e.target.closest(
                        '.btn-anular-venta'))) {
