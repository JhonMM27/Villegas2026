<div class="table-responsive">
    <table class="table table-bordered table-sm table-app" id="tablaDetalles">
        ...
        <tfoot>
            <tr>
                <td colspan="9" class="text-end"><strong>OP. Gravada</strong></td>
                <td>
            ...
            <tr>
                <td colspan="9" class="text-end"><strong>OP. Exonerada</strong></td>
                <td>
            ...
            <tr>
                <td colspan="9" class="text-end"><strong>OP. Inafecta</strong></td>
                <td>
            ...
            <tr>
                <td colspan="9" class="text-end"><strong>Impuesto</strong></td>
                <td>
