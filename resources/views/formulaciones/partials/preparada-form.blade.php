<div class="border border-primary rounded p-3">
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <input type="hidden" id="producto_id_preparada" name="producto_id_preparada" class="form-control form-control-sm">
            <input type="text" id="producto_nombre_preparada" name="producto_nombre_preparada" class="form-control form-control-sm" autocomplete="off">
