...
<body>
    ...
    <table class="reporte">
        <thead>
            <tr>
                <th>Proveedor</th>
                <th class="text-right">Cant.Docs</th>
        ...
        <tbody>
            @forelse($grupos as $g)
                <tr>
                    ...
                    <td class="text-right">{{ (int) $g['cantidad_docs'] }}</td>
            ...
            @empty
                <tr>
                    <td colspan="7" class="text-center">No se encontraron créditos por pagar</td>
                </tr>
            @endforelse
            ...
            @if(count($grupos) > 0)
                <tr class="total-row">
                    ...
                    <td class="text-right">{{ (int) $totCantDocs }}</td>
