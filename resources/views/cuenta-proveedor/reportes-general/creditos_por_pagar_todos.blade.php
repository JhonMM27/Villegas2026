...
<html>
@include('pdf.styles', [
    'title' => "Relación de créditos por pagar ({$ini->format('d/m/Y')} al {$fin->format('d/m/Y')})"
])
<body>
...
<div class="page-header">
    <table>
        ...
        <tr>
            <td>Reporte: Relación de créditos por pagar ({{ $ini->format('d/m/Y') }} al {{ $fin->format('d/m/Y') }})</td>
            <td class="text-right">
