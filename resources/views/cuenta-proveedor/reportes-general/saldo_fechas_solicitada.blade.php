...
<html>
@include('pdf.styles', [
  "title" => "Relación de Saldo por pagar desde {$ini->format('d/m/Y')} hasta {$fin->format('d/m/Y')}"
])
<body>
    ...
    <div class="page-header">
        <table>
            ...
            <tr>
                <td>Relación de saldo por pagar desde {{$ini->format('d/m/Y')}} hasta {{$fin->format('d/m/Y')}}</td>
                <td class="text-right">
    ...
    <table class="reporte">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="9" class="text-center">No se encontraron créditos por pagar</td>
                </tr>
            @endforelse
