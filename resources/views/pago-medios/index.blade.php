        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center">
                    <h3 class="card-title flex-grow-1">Medios de Pago</h3>
                    @can('pago_medios_create')
...
@canany(['pago_medios_create', 'pago_medios_edit'])
    @include('pago-medios.action')
@endcanany
@endsection
@push('scripts')
<script>
class PagoMedioManager extends CrudManager {
    constructor() {
        super("{{ url('pago-medios') }}");
    ...
    async showEditModal(id) {
        try {
            ...
            this.elements.modalTitle.textContent = 'Editar Medio de Pago: '+ response.descripcion;
    ...
    showCreateModal(){
        ...
        this.elements.modalTitle.textContent = 'Nuevo medio de Pago';
    }
}
document.addEventListener('DOMContentLoaded', () => {
    new PagoMedioManager();
});
document.getElementById('mnuConfiguracion').classList.add('menu-open');
document.getElementById('itemPagoMedio').classList.add('active');
</script>
@endpush
