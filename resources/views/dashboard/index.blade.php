                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="card card-info card-outline mb-4">
                                        ...
                                        <div class="card-header">
                                            <div class="card-title" style="font-size:14px;">Productos más comprados en el mes
                                            </div>
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->
                                ...
                                <div class="col-lg-6">
                                    <div class="card card-info card-outline mb-4">
                                        <!--begin::Header-->
                                        <div class="card-header">
                                            <div class="card-title" style="font-size:14px;">Compras en los últimos 15 días</div>
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->
                                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="card card-info card-outline mb-4">
                                        <!--begin::Header-->
                                        <div class="card-header">
                                            <div class="card-title" style="font-size:14px;">Productos más vendidos en el mes
                                            </div>
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->
                                ...
                                <div class="col-lg-6">
                                    <div class="card card-info card-outline mb-4">
                                        <!--begin::Header-->
                                        <div class="card-header">
                                            <div class="card-title" style="font-size:14px;">Ventas en los últimos 15 días</div>
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->
                                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card card-info card-outline mb-4">
                                        <!--begin::Header-->
                                        <div class="card-header">
                                            <div class="card-title" style="font-size:14px;">Productos con bajo Stock</div>
                                        </div>
                                        <!--end::Header-->
                                        <!--begin::Body-->
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card card-danger card-outline mb-4">
                                            <!--begin::Header-->
                                            <div class="card-header">
                                                <div class="card-title" style="font-size:14px;"><i
                                                        class="bi bi-exclamation-triangle-fill me-1"></i>Productos con Stock
                                                    Negativo (Activos)</div>
                                            </div>
                                            <!--end::Header-->
                                            <!--begin::Body-->
                                            <div class="card-body p-0">
                                                    ...
                                                    <div class="col-lg-6 border-end">
                                                        @foreach ($col1Neg as $producto)
                                                            <div class="progress-group px-3 py-2 border-bottom">
                                                                ...
                                                                <span class="float-end">
                                                                    <b class="text-danger">{{ $producto->stock_almacen }}</b>
                                                                    / {{ $producto->stock_minimo }}
                                                                </span>
