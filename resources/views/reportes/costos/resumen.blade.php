...
<div id="modalContainerCostos"></div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        btnFiltrar.addEventListener('click', function() {
            ...
            const url = new URL("{{ route('reportes.costos.resumen') }}", window.location.origin);
        ...
        btnExportar.addEventListener('click', function () {
            ...
            const url = new URL(
                "{{ route('reportes.costos.resumen.export') }}",
        ...
        document.getElementById('btnPdf').addEventListener('click', function (e) {
            ...
            const url = new URL("{{ route('reportes.costos.resumen.imprimir') }}", window.location.origin);
            url.searchParams.append('fecha_inicio', fechaInicio);
            url.searchParams.append('fecha_fin', fechaFin);
            if (tipo) url.searchParams.append('tipo', tipo);
