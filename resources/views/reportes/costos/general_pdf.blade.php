...
<html>
<head>
    <title>Reporte General de Costos</title>
    <meta charset="utf-8">
    <style>
...
<body>
    ...
    <div class="page-header">
        <table>
            ...
            <tr>
                <td>Reporte General de Costos ({{ \Carbon\Carbon::parse($fechaInicio)->format('d/m/Y') }} - {{ \Carbon\Carbon::parse($fechaFin)->format('d/m/Y') }})</td>
        ...
        <tbody>
            @php
                ...
                foreach($reportes as $r) {
                    $cat = $r->categoriaCosto?->nombre ?? 'SIN CATEGORIA';
