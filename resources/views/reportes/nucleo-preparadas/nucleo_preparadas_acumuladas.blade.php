...
document.addEventListener('DOMContentLoaded', function() {
    ...
    btnFiltrar.addEventListener('click', function() {
        ...
        const url = new URL("{{ route('reportes.nucleo_preparadas_acumuladas') }}", window.location.origin);
    ...
    document.getElementById('btnPdfAcumuladas').addEventListener('click', function (e) {
        ...
        const url = `{{ route('reportes.nucleo_preparadas_acumuladas.imprimir') }}?fecha_inicio=${fechaInicio}&fecha_fin=${fechaFin}`;
