            ...
            @forelse($reportes as $item)
                ...
                @if($fechaActual !== null && $fechaActual !== $fechaCompra)
                    <tr class="subtotal-dia">
                        <td colspan="5" class="text-right">Subtotal {{ \Carbon\Carbon::parse($fechaActual)->format('d/m/Y') }}</td>
                        <td class="text-right">{{ $subtotalItemsDia }}</td>
                ...
                {{-- FILA NORMAL --}}
                <tr class="linea2">
                    <td>{{ \Carbon\Carbon::parse($fechaCompra)->format('d/m/Y') }}</td>
