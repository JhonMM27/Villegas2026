                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="border border-primary rounded-3 p-3">
                                <div class="row g-3">
                                    <div class="col-6">
                                        <label for="fecha_costo" class="form-label text-muted small">Fecha Costo</label>
                                        <input type="datetime-local" id="fecha_costo" name="fecha_costo" class="form-control form-control-sm">
                                    ...
                                    <div class="col-6">
                                        <label for="categoria_costo_id" class="form-label text-muted small">Categoría <span class="text-danger">*</span></label>
                                        <select id="categoria_costo_id" name="categoria_costo_id" class="form-select form-select-sm" required>
                                            <option value="">Seleccione...</option>
                                        </select>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    <div class="col-6">
                                        <label for="costo_tipo_id" class="form-label text-muted small">Tipo <span class="text-danger">*</span></label>
                                        <select id="costo_tipo_id" name="costo_tipo_id" class="form-select form-select-sm" required>
                                            <option value="">Seleccione...</option>
                                        </select>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <label for="descripcion" class="form-label text-muted small">Descripción <span class="text-danger">*</span></label>
                        ...
                        <div class="col-lg-5">
                            @include('costos.partials.cobranza')
                        </div>
                    </div>
                </div>
